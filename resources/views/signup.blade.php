    ...
    <div class="container1" style="margin: 30px">
      <div class="col">
        <div class="container2">
          ...
          <h1 class="title2 text-center">ComQuiz</h1>
          <form style="padding-bottom: 60px; padding-right: 90px; padding-left: 40px; padding-top: 10px" action="/signup" method="post">
          @csrf
            <fieldset class="">
              <p>
              ...
              <p>
                ...
                <input class="form-control" type="text" name="fullname" id="nama" required />
              </p>
              <p>
              ...
              <div class="button-container">
                <div class="d-grid gap-2">
                  ...
                  <button class="button2"><a href="/welcome" class="akun">Log In</a></button>
                </div>
              </div>
            </fieldset>
          </form>
